...
class ForeignExchangeOutright():
    ...
    # Currency 2 :: The currency of the cash flows of the second leg (if not defined, main currency applies)
    currency2 : str
    ...
    # Notional Principal 2 :: Notional amount of the second currency to be exchanged in an FXOUT CT.
