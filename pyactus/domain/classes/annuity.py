...
class Annuity():
    ...
    # Amortization Date :: This Date is used to calculate the annuity amounts for ANN and ANX NGX CT's. Needs only to be set in case where the contract balloon at MD and MD is less than AD.
    amortization_date : datetime.datetime
